...
# @fh_jet_selection.init
# def fh_jet_selection.init(self: Selector) -> None:
...
#         self.jet_trigger = {
#             2016: "HLT_PFHT400_SixJet30_DoubleBTagCSV_p056",
# or "HLT_PFHT450_SixJet40_BTagCSV_p056")
#             2017: "HLT_PFHT380_SixPFJet32_DoublePFBTagCSV_2p2",
