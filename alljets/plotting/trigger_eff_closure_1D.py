...
def plot_efficiencies_no_weight(
    ...
    **kwargs,
    ...
    norm_hist_0 = np.array(myhist_0[1, :, 0].values())
    norm_hist_1 = np.array(myhist_1[1, :, 0].values())

    plot_config["hist_0"] = {
        "method": "draw_efficiency",
        "ratio_method": "draw_hist",
        "hist": myhist_0[1, :, eff_bin],
        "kwargs": {
            "color": "b",
            "norm": norm_hist_0,
        ...
        "ratio_kwargs": {
            ...
            "capsize": 3,
            "linestyle": "none",
            "norm": (myhist_1[1, :, eff_bin].values() * norm_hist_0) / norm_hist_1,
            "histtype": "errorbar",
        },
    }
    ...
    **kwargs,
    ...
    plot_config["hist_0"] = {
        ...
        "ratio_kwargs": {
            ...
            "capsize": 3,
            "linestyle": "none",
            "norm": (myhist_1[0, :, eff_bin].values() * norm_hist_0) / norm_hist_1,
            "histtype": "errorbar",
        },
    }
