...
"--variables gen_top1_pt-gen_top1_min_deltaR_4bins "
"--plot-function alljets.plotting.2Dto1D_plot.plot_2Dto1D_3plots_integral"
" --remove-output 0,a,y "
"--cms-label simpw"
...
def plot_2Dto1D_3plots_integral(
    ...
    **kwargs,
    ...
    default_style_config["ax_cfg"]["xlabel"] = x_label + " Cut" + " / " + "GeV"
    default_style_config["legend_cfg"]["ncol"] = 1
    default_style_config["legend_cfg"]["title_fontsize"] = 17
    default_style_config["legend_cfg"]["fontsize"] = 20
    default_style_config["rax_cfg"]["ylim"] = (0.61, 1.39)
