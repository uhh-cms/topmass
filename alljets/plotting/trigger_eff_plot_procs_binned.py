    ...
    **kwargs,
    ...
    for i in range(num_bins):
        ...
        text = (
            ...
            f"{myhist_0[0, :, eff_bin].axes[0].label}:"
            f"{int(myhist_0[0, :, eff_bin].axes.edges[0][i])} to "
            f"{int(myhist_0[0, :, eff_bin].axes.edges[0][i+1])}"
        )
    ...
    for i in range(num_bins):
        ...
        text = (
            ...
            f"{myhist_1[0, :, eff_bin].axes[0].label}:"
            f"{int(myhist_1[0, :, eff_bin].axes.edges[0][i])} to "
            f"{int(myhist_1[0, :, eff_bin].axes.edges[0][i + 1])}"
        )
