...
law run cf.PlotVariables1D --version v1 --configs 2017_v9
--processes tt --variables distance_pt_diff*_2bins
--datasets tt_fh_powheg
--plot-function alljets.plotting.print_proportions.countNegativePositive
"""
...
def countNegativePositive(
    ...
    **kwargs,
    ...
    norm = sum(hists_base[0, :].values())
    print("#" * 25 + category_inst.name + "__" + variable_insts[0].name + "#" * 25)
    print("Positiv: ", hists_base[0, 1].value / norm * 100, " %")
    print("Negative: ", hists_base[0, 0].value / norm * 100, " %")
    print("#" * 50 + "#")
