...
```
law run cf.CreateDatacards --inference-model default_1D --hist-hooks qcd   --version v1_Topmass  --configs 2017_v9  --selector default --cf.MergeShiftedHistograms-workflow htcondor --cf.MergeShiftedHistograms-pilot  --htcondor-memory 1800MB --htcondor-runtime 3h --workers 10 --cf.MergeShiftedHistograms-shift-source-chunk-size 3
