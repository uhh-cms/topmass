...
action() {
    ...
    cf_cmssw_custom_setup() {
        source "${CMSSW_BASE}/venvs/cmsswtest/bin/activate" "" &&
        export PYTHONPATH="${PYTHONPATH}:/afs/desy.de/user/g/griesinl/pykinFit/:$( python -c "import os; print(os.path.normpath('$( root-config --libdir )'))" )"
  export LD_LIBRARY_PATH=/afs/desy.de/user/g/griesinl/pykinFit/lib/el9_amd64_gcc12/6.26.11/:/cvmfs/cms.cern.ch/el9_amd64_gcc12/cms/cmssw/CMSSW_13_3_0/external/el9_amd64_gcc12/lib/:$LD_LIBRARY_PATH
